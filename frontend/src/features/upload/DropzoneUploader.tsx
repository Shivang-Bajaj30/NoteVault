...
export function DropzoneUploader({ onSuccess }: DropzoneUploaderProps) {
  ...
  return (
    <Card className="p-6 sm:p-8 border-brand-200/70 dark:border-brand-900/40 shadow-sm bg-gradient-to-b from-white via-white to-brand-50/20 dark:from-zinc-900 dark:via-zinc-900 dark:to-brand-950/20">
      {uploadFeedback ? (
        <div className="py-10 text-center space-y-3">
          ...
          <Button
            ...
            className="mt-3 font-semibold text-brand-700 dark:text-brand-300 border-brand-200 dark:border-brand-800"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pb-3 border-b border-brand-100 dark:border-zinc-800">
            <h3 className="text-base font-bold text-stone-900 dark:text-zinc-100 flex items-center gap-2">
              <span className="w-7 h-7 rounded-lg bg-brand-600 text-white flex items-center justify-center text-xs shadow-xs">
          ...
          {!file ? (
            <div
              ...
              className={`p-10 rounded-2xl border-2 border-dashed transition-all text-center cursor-pointer flex flex-col items-center justify-center ${
                dragOver
                  ? 'border-brand-500 bg-brand-100/50 dark:bg-brand-950/50 scale-[1.01]'
                  : 'border-brand-300/80 hover:border-brand-500 bg-gradient-to-b from-brand-50/60 via-amber-50/30 to-white dark:border-brand-800/80 dark:bg-zinc-800/50 hover:shadow-md'
              }`}
            >
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-brand-600 to-amber-600 text-white flex items-center justify-center mb-3 shadow-md shadow-brand-500/25">
            ...
            <div className="flex items-center justify-between p-4 rounded-xl border border-brand-200 dark:border-brand-900/60 bg-brand-50/40 dark:bg-brand-950/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <select
                ...
                className="w-full px-3 py-2 text-xs bg-white dark:bg-zinc-800 border border-stone-300 dark:border-zinc-700 rounded-lg text-stone-900 dark:text-zinc-100 focus:ring-1 focus:ring-brand-500 focus:outline-none"
              >
                {classes.map((c) => (
